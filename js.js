...
function store(){ //stores items in the localStorage
    var key = document.getElementById('pid').value;
    var name = document.getElementById('pname').value;
    var price = document.getElementById('pprice').value;
    var image = document.getElementById("pimage").src;
    const Product = { 
        name: name,
        price: price,
        pimage: image 
...
function retrieveRecords(){ //retrieves items in the localStorage
    var key = document.getElementById('pid').value; //gets key from user
...
window.onload =function(){ //ensures the page is loaded before functions are executed.
    document.getElementById("add-product-btn").onclick = store
    document.getElementById("find-product-btn").onclick = retrieveRecords
}